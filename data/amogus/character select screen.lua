...
local ofsy = 0
local mult = 1.25
characterNames = {'bf', 'pico-player', 'bf-og', 'spooky', 'mom', 'monster', 'senpai', 'spirit'} --character json name
characterDisplays = {'Boyfriend', 'Pico', 'Slipfriend', 'spooky kids', 'mom', 'monster', 'senpai', 'spirit'} --display name for text
characterLimit = {3, 1, 1, 1, 1, 2, 2, 1} --how many variations does the character have
maxpage = 3 --amount of characters u have
  ...
  if getPropertyFromClass('flixel.FlxG', 'keys.justPressed.ENTER') then
    if inSelection == true and getProperty('inCutscene') == true then
      ...
      if page < 4 then
        ...
        objectPlayAnimation('boyfriend', 'hay', true)
      end
...
function setVariation()
  ...
  elseif variation == 2 then
    characterNames = {'bf-christmas', 'pico-player', 'bf-og', 'spooky', 'mom', 'monster-christmas', 'senpai-angry', 'spirit'} --character json name
    characterDisplays = {'Boyfriend (christmas)', 'Pico', 'Slipfriend', 'spooky kids', 'mom', 'monster (christmas)', 'senpai (mad)', 'spirit'} --display name for text
  elseif variation == 3 then
    characterNames = {'bf-pixel', 'pico-player', 'bf-og', 'spooky', 'mom', 'monster-christmas', 'senpai-angry', 'spirit'} --character json name
    characterDisplays = {'Boyfriend (pixel)', 'Pico', 'Slipfriend', 'spooky kids','mom', 'monster (christmas)', 'senpai (mad)', 'spirit'} --display name for text
  end
end
